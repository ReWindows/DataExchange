//! Windissect-generated Rust FFI bindings for DataExchange.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "97D69F9EE663B1AEC5CFBB39810797E0";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2122078328;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 17] = [68, 97, 116, 97, 69, 120, 99, 104, 97, 110, 103, 101, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2122078328 { return 0; }
