// Flat C exports observed in DataExchange.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef DATAEXCHANGE_C_H
#define DATAEXCHANGE_C_H
