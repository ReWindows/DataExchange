...
static constexpr wchar_t module_name[17] = {0x0044, 0x0061, 0x0074, 0x0061, 0x0045, 0x0078, 0x0063, 0x0068, 0x0061, 0x006E, 0x0067, 0x0065, 0x002E, 0x0064, 0x006C, 0x006C, 0x0000};
...
if (live_timestamp != 2122078328U || rva >= image_size) return nullptr;
return base + rva;
}
